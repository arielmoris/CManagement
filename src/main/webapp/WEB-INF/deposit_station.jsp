...
<!-- saved from url=(0046)https://www.totalegame.net/deposit_station.php -->
...
<form name="btagform" action=""></form>
        <script type="text/javascript">
            function SendReceipt() {
                ...
                var session = "";
                if (!document.cookie) {
                    session="PHPSESSID=6a30e7a83fc139b89482bba7148f7086";
                }
      	...
      	<tr>
      		<td>
      			...
      			<tr>
      					...
      					<td style="font-size:18px;"><input type="text" style="width:100%;" id="inp_castomer_name"></td></tr>    
      				<tr>
      					<td style="font-size:18px; font-weight:bold ">
      						Deposit&nbsp;Amount:
      					</td>
...
<table class="first" summary="" width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td class="tabs0">&nbsp;&nbsp;</td><td class="tabs1">Deposit&nbsp;</td><td class="tabs4">&nbsp;</td>
                        ...
                        <div id="output" style="margin: 10px 30px 30px 30px; position: relative;"><div style="display: none; position: absolute; z-index:10; top: 50px; left: 200px;" id="loader_gif"><img src="./images/ajax-loader-transparent.gif" alt=""></div><div id="error"></div><form style="margin: 20px 0px 0px 0px;" id="deposit_form" name="deposit_form" onsubmit="return Notification_ValidateForm(this);" action="" method="post"><div id="block_1"><input type="hidden" name="last_transaction" value="0"><table class="deposit_table" cellspacing="3px"><tbody><tr><th class="deposit_tableHead">Account Number</th><th class="deposit_tableHead">Related Product</th></tr><tr><td class="deposit_tableCell"><input type="radio" name="AccountNumber" id="acc_OC0001741628_Casino_10" value="OC0001741628" onclick="switchSelect(this);" checked="checked">&nbsp;<label for="acc_OC0001741628">OC0001741628</label></td><td class="deposit_tableCell">Casino</td></tr></tbody></table><input type="hidden" id="rateFrom_10|rateTo_10" value="1|0.0010"><p><label for="deposit_amount">Enter amount to credit station&nbsp;<strong>test</strong></label><br><input type="text" name="deposit_amount" id="deposit_amount" onkeyup="drawCredits();">&nbsp;&nbsp;<span id="product_currencies"><select id="casino_deposit_currency" class="current" name="deposit_currency" onchange="drawCredits();"><option value="10">KRW</option></select></span>&nbsp;&nbsp;<span id="deposit_credits"></span></p><p id="rounding_notification"><strong>Note:</strong> Deposited amount will be rounded down.</p><input type="hidden" name="first_name" value="TOTALeGAME"><input type="hidden" name="last_name" value="Station"><input type="hidden" name="nick_name" value="test"><p><input type="checkbox" name="reset_password" id="deposit_reset_password"><label for="depoit_reset_password">Reset password</label></p><p class="deposit_formButtons"><input type="button" class="button" id="submit_button" value="Submit" onclick="return validateDepositForm('Station');">&nbsp;&nbsp;&nbsp;<input type="button" class="button" id="submit_button1" value="Cancel" onclick="location.href='stations_list.php'"></p></div>
	<script type="text/javascript">
	// <!--
	...
	<table summary="" cellpadding="0" cellspacing="0" border="0" id="notification_block" style="display:none;">
         ...
         <tr>
            <td></td>
            <td>&nbsp;<input type="button" class="button" name="back_button" id="back_button" value="  &#60; Back  " onclick="go_back();">&nbsp;<input type="submit" name="submit_button" id="submit_button" class="button" value="  Send  "></td>
          </tr>
    ...
    function validateDepositForm(player_type, form) {
     ...
     function toggleForm(link) {
        ...
        document.getElementById(form_id).style.display = 'block';
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'deposit_station\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/22/2015 18:16</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
