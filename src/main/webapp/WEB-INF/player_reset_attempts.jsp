...
<!-- saved from url=(0052)https://www.totalegame.net/player_reset_attempts.php -->
...
<table class="first" summary="" width="100%" cellpadding="0" cellspacing="0" border="0">
    <tbody><tr valign="top">
        ...
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td class="tabs0">&nbsp;&nbsp;</td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="https://www.totalegame.net/update_player.php" class="tabsmenu">View&nbsp;Details </a></td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="https://www.totalegame.net/player_status.php" class="tabsmenu">Lock/Unlock&nbsp;</a></td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="https://www.totalegame.net/player_reset_password.php" class="tabsmenu">Reset&nbsp;Password </a></td><td class="tabs1">Reset&nbsp;Login Attempts&nbsp;</td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="https://www.totalegame.net/send_game.php" class="tabsmenu">Mobile&nbsp;Games </a></td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="https://www.totalegame.net/agent_earning_report.php" class="tabsmenu">View&nbsp;Player Earnings&nbsp;</a></td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="https://www.totalegame.net/game_profitability_report_by_account.php" class="tabsmenu">Profit&nbsp;by Game&nbsp;Type </a></td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
                        </span>
	...
	//-->
	       ...
	       <input type="hidden" name="AccountNumber" value="">
	        ...
	        <tr><td><table id="bulk_result" class="printable tab_body table table-bordered table-condensed table-hover table-striped"><tbody><tr><td style="padding:3px;" class="tab_head">Account Number&nbsp;</td><td style="padding:3px;" class="tab_head">Related Product&nbsp;</td><td style="padding:3px;" class="tab_head">Login Attempts&nbsp;</td></tr><tr>
				        ...
				        <td style="padding:3px;" class="tab_row1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;0&nbsp;&nbsp;</td></tr></tbody></table></td><td> <img src="./images/cmt_yes.gif" id="AccountNumber_gif_yes" width="13" height="13" alt="" style="display:none;"><img src="./images/cmt_no.gif" id="AccountNumber_gif_no" width="13" height="13" alt="" style="display:none;"></td></tr>
	        <tr><td colspan="2">Click Reset to reset the player's login attempts and enable player login using the current user name and password.</td></tr>
	        <tr><td colspan="2"><br></td></tr>
	           <tr><td align="center" colspan="2">
	           <input type="button" class="button" value=" Cancel  " onclick="location.href='players_list.php'">
	           <input type="submit" name="submit_button" id="submit_button" class="button" value=" Reset  ">
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'player_reset_attempts\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/23/2015 18:35</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
