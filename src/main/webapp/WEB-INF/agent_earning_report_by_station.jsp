...
<!-- saved from url=(0062)agent_earning_report_by_station.jsp -->
...
<table class="top" summary="" width="760" cellpadding="0" cellspacing="0" border="0">
      ...
      <div class="tabs_table">
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            ...
            <td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="${pageContext.request.contextPath}/agentEarningReportByAccount" class="tabsmenu">Casino&nbsp;Earnings Report&nbsp;by Player&nbsp;</a></td><td class="tabs1">Casino&nbsp;Earnings Report&nbsp;by Station&nbsp;</td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
	   ...
	   <script type="text/javascript">
			...
			function SubmitReport(){
				...
				if(CheckDate(document.getElementById('from_date').value, document.getElementById('to_date').value))
					sndReqAgentEarningReport('get_agent_earning_report_by_account.php',document.getElementById('from_date').value,document.getElementById('to_date').value,select_list_arr,'Station','',session);
			}
				</script>
  ...
  <td class="left" nowrap="nowrap" style="padding-left:15px;">
      <div class="welcome">
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'agent_earning_report_by_station\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/9/2015 15:29</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
