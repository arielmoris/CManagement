...
<!-- saved from url=(0045)https://www.totalegame.net/reset_password.php -->
    ...
    <tbody><tr valign="top">
        ...
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            ...
            <td class="tabs1">Reset&nbsp;Password </td><td class="tabs3" onmouseover="this.className=&#39;tabs2&#39;;" onmouseout="this.className=&#39;tabs3&#39;;">
            ...
            <a href="${pageContext.request.contextPath}/changeCommissionFee" class="tabsmenu">Commission&nbsp;Fee </a></td><td class="tabs4">&nbsp;</td>
                        ...
                        <div class="box_tabs" style="position:relative; height: 300px !important;"><div style="display:none; position:absolute; z-index:10; top:100px; left:220px;" id="loader_gif"><img src="./images/ajax-loader-transparent.gif" alt=""></div><div style="position:absolute; z-index:0; width: 95%;">
<script type="text/javascript">
// <!--
...
sndReqResetPassword('big157123',document.agent_form.notify_email.value,document.agent_form.notify_sms.value,'','',session);
}
//-->
</script>
       <span id="error"></span>
       <form class="form-horizontal" action="https://www.totalegame.net/agents_list.php" method="post" name="agent_form" id="agent_form" onsubmit="return Notification_ValidateForm(this);">
        <table summary="" cellpadding="0" cellspacing="10" border="0" id="block_1" style="display:block;">
        <tbody><tr><td>Click the Reset Password button to change the password.</td></tr>
         <tr><td><br></td></tr>
           <tr><td align="center">
           <input type="button" class="button" value=" Cancel  " onclick="location.href=&#39;agents_list.php&#39;;">&nbsp;<input type="button" class="button" value=" Reset Password  " onclick="return ValidateForm(document.getElementById(&#39;agent_form&#39;));">
           </td></tr>
        </tbody></table>
	...
	Send account password to:<br></br>

       <div class="form-group">
       <div class="col-sm-3">
       		<input type="checkbox" value="notify_email" name="notify" id="notify" onclick="if(this.checked==true) document.agent_form.notify_email.disabled=false; else document.agent_form.notify_email.disabled=true;">E-mail address&nbsp;
       </div>
    <div class="col-sm-10">
     	<input type="text" class="field" value="" name="notify_email" id="notify_email" disabled=""> <img src="./images/cmt_yes.gif" id="notify_email_gif_yes" width="13" height="13" alt="" style="display:none;"><img src="./images/cmt_no.gif" id="notify_email_gif_no" width="13" height="13" alt="" style="display:none;">
    </div>
  </div>
  
       <div class="form-group">
       <div class="col-sm-3">
       		<input type="checkbox" value="notify_sms" name="notify" id="notify" onclick="if(this.checked==true) document.agent_form.notify_sms.disabled=false; else document.agent_form.notify_sms.disabled=true;">SMS to&nbsp;
       </div>
    <div class="col-sm-10">
     	<input type="text" class="field" value="" name="notify_sms" id="notify_sms" disabled="disabled"> <img src="./images/cmt_yes.gif" id="notify_sms_gif_yes" width="13" height="13" alt="" style="display:none;"><img src="./images/cmt_no.gif" id="notify_sms_gif_no" width="13" height="13" alt="" style="display:none;"><br><font style="font-size: 11px;"><i><b>Note:</b> Please enter phone number including country code.</i></font>
              </div>
  </div>
  
  	<input type="button" class="button" name="back_button" id="back_button" value="  Cancel  " onclick="location.href=&#39;agents_list.php&#39;">&nbsp;<input type="submit" name="submit_button" id="submit_button" class="button" value="  Submit  ">
        ...
        <span id="output"></span>
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'a155755\',\'reset_password\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 0.00  USD</b>
					</div>
				</span>Welcome, <strong>a a</strong><br>Representative<br><em><font size="1px"><span id="gmt_time">2/9/2015 12:35</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
