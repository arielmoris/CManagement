...
//<input type="radio" value="U" name="datefmt">M D Y <input type="radio" value="W" name="datefmt">D M Y <input type="radio" value="J" name="datefmt">Y M D<br>
//<input type="radio" value="P" name="daterng">Past <input type="radio" value="A" name="daterng">Any <input type="radio" value="F" name="daterng">Future<br>
//<input type="text" name="mydate" value="" size="20" maxlength="20"><input type="button" name="submitit" value="Validate Date" onclick="if (validateDate(myform.mydate.value,valDateFmt(myform.datefmt),valDateRng(myform.daterng))) {alert('Date is Valid'); return false;} else {alert('Date is Invalid or Out of Range'); return false;}">
//</form>
...
if (yy < 100) yy += 2000;
if (yy < 1800 || yy > 4881) return false;
