...
<c:choose>
	<c:when test="${requestStatus.code eq 0}">
			...
			<thead>
				<tr>
				     <td class="tab_head1 sortable" align="center">
				         <a class="tablink" style="cursor:pointer;" data-column="0" data-order="desc">Player Code</a>
				     </td>
				     <td class="tab_head1 sortable" align="center">
				         <a class="tablink" style="cursor:pointer;" data-column="1" data-order="desc">Username</a>
				     </td>
		 	 ...
		 	 <tbody>
		  		...
		  		<c:forEach var="player" items="${playersListDto.playerListResponseData}">
				  		<tr>
					 		...
					 		<td class="tab_row1" nowrap="nowrap" align="right">
					 			<a href="#" onclick="return editBalance('${player.pUsername}','CR')">Load</a>
					 		</td>
					 		<td class="tab_row1" nowrap="nowrap" align="right">
					 			<a href="#" onclick="return editBalance('${player.pUsername}','DR')">Withdraw</a>
					 		</td>
					 		<td class="tab_row1" nowrap="nowrap" align="right">PlayCheck</td>
					 		<td class="tab_row1">
					 			<a href="#" onclick="return editPlayer('${player.pUsername}')">
		...
		<div class="balance">
			...
			<b>Total agents: $playersListDto.record.totalRecords}</b>
		</div>
		<script>
			$(function(){
				var orderBy 	= "${playersListDto.record.orderBy}";
				var orderType 	= "${playersListDto.record.orderType}";
