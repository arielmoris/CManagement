...
<!-- saved from url=(0045)https://www.totalegame.net/station_status.php -->
    ...
    <tbody><tr valign="top">
        ...
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            ...
            <td class="tabs1">Lock/Unlock&nbsp;</td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="${pageContext.request.contextPath}/stationResetPassword" class="tabsmenu">Reset&nbsp;Password </a></td>
            <td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="${pageContext.request.contextPath}/stationResetAttempts" class="tabsmenu">Reset&nbsp;Login Attempts&nbsp;</a></td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
                        </span>
                        <div class="box_tabs" id="output" style="position:relative;height: 250px !important;"><div style="display:none; position:absolute; z-index:10; top:50px; left:220px;" id="loader_gif"><img src="./images/ajax-loader-transparent.gif" alt=""></div><div style="position:absolute; z-index:0; width: 95%;">
...
//return false;
  var session='';
  if(!document.cookie)
  session='PHPSESSID=16d059a65d6dfd8944ad3e93abcda8d3';
...
//-->
       ...
       <input type="hidden" name="AccountNumber" value="">
        ...
        <tbody><tr><td colspan="2">Station <b>test</b></td></tr>
        <tr><td>
        <br>
        <table id="bulk_result" class="printable tab_body table table-bordered table-condensed table-hover table-striped">
        <tbody>
        <tr><td style="padding:3px;" class="tab_head">Account Number&nbsp;</td><td style="padding:3px;" class="tab_head">Related Product&nbsp;</td><td style="padding:3px;" class="tab_head">Status&nbsp;</td></tr><tr>
                        ...
                        <input name="lock_OC0001741628" id="lock_OC0001741628_Lock" value="true" type="radio">Lock<br>
                        <input name="lock_OC0001741628" id="lock_OC0001741628_Open" value="false" type="radio" checked="checked" disabled="disabled">Unlock</td></tr></tbody></table>
                        
           </td>
           <td> <img src="./images/cmt_yes.gif" id="lock_gif_yes" width="13" height="13" alt="" style="display:none;"><img src="./images/cmt_no.gif" id="lock_gif_no" width="13" height="13" alt="" style="display:none;"></td></tr>
            <tr>
            	<td colspan="2"><br></td>
            </tr>
            <tr>
            <td align="center" colspan="2">&nbsp;<input type="button" class="button" name="back_button" id="back_button" value="  Cancel  " onclick="location.href='${pageContext.request.contextPath}/stationsList'">&nbsp;<input type="submit" name="submit_button" id="submit_button" class="button" value="  Save  "></td>
          </tr>
        </tbody></table>
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'station_status\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/22/2015 15:37</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
