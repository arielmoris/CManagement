...
//******************************************************************************
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #DDDDDD;'   +
                                        'color:             #000000;}'  +
            '/* Week number heading */'                                 +
            ...
            'td.scwInputDate            {background-color:  #C01E00;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Weekend Day */'                                         +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #F66013;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  #FFFFBD;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #000000;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #FFFFBD;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #FFFFBD;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #000000;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot:hover,'                                         +
            'td.scwFootHover            {color:             #FFFFBD;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'font-weight:       bold;}'     +
            '/* Disabled cells */'                                      +
        ...
        {scwTriggerEle = scwSourceEle;
         ...
         if (scwID('scwIframe'))
            {scwID('scwIframe').style.top=offsetTop +'px';
             ...
             scwID('scwIframe').style.zIndex=2;
            }
