...
<!-- saved from url=(0041)contact_us.jsp -->
        ...
        <td class="center">
            ...
            <table class="top" summary="" width="760" cellpadding="0" cellspacing="0" border="0">
				...
				<div class="system">Management System</div>
                        ...
                        If you encounter any problems or need assistance, please contact your system provider.
                    </td>
					<td class="left" nowrap="nowrap" style="padding-left:15px;">
                        <div class="welcome">
                            
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'contact_us\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/9/2015 18:08</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
