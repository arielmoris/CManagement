...
<!-- saved from url=(0052)https://www.totalegame.net/prog_game_play_report.php -->
...
<div style="display:none; position:absolute; z-index:10; top:250px; left:500px;" id="loader_gif"><img src="./images/ajax-loader-transparent.gif" alt=""></div>
	...
	<div id="wind1" class="wins">
		...
		<table align="center" valign="middle" width="100%" cellpadding="10" cellspacing="10" style="position:relative;">
			<tbody><tr valign="top">
      			<td align="center" colspan="2" height="600"><span id="error1"></span><span id="window_result"></span></td>
      		</tr>
		</tbody></table>
		</span>
	</div>
...
<table class="top" summary="" width="760" cellpadding="0" cellspacing="0" border="0">
  <tbody><tr valign="top">
    <td class="content">
      ...
      <div class="tabs_table">
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td class="tabs0">&nbsp;&nbsp;</td><td class="tabs1">Progressive&nbsp;Game Play&nbsp;</td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
    ...
    <div class="row">
     ...
     <br>
		<div class="row"><label class="col-sm-6">Agent</label></div>
		<div class="row">
        <div class='col-sm-6'>
            <div class="col-sm-4" style="padding-left:0px;">
                <select path="transactionType" name="summary_level" id="summary_level" class="field" style="width:220px;">
...
function SubmitReport(summaryCurrency)
{
	...
	select_summary_level1='ByMember';
	if(document.getElementById('summary_level1'))
		select_summary_level1=document.getElementById('summary_level1').value;
	...
	if(CheckDate(from_date, to_date))
		if (!summaryCurrency) {
            summaryCurrency = '';
        }
        var txt = '';
        ...
        /*
        sndReqCreditReport(
            'get_prog_game_play.php',
            document.getElementById('from_date').value,
            document.getElementById('to_date').value,
            select_list_arr,
            select_summary_level,
            select_summary_level1,
            include_test,
            '',
            session,
            summaryCurrency
    ...
    <td class="left" nowrap="nowrap">
      <div class="welcome">
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'a155755\',\'prog_game_play_report\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 0.00  USD</b>
					</div>
				</span>Welcome, <strong>a a</strong><br>Representative<br><em><font size="1px"><span id="gmt_time">2/9/2015 18:56</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
