...
<!-- saved from url=(0062)agent_game_profitability_report.jsp -->
   ...
   <div class="system">Management System</div>
      ...
      <div class="tabs_table">
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td class="tabs0">&nbsp;&nbsp;</td><td class="tabs1">Casino&nbsp;Profit by&nbsp;Game Type&nbsp;</td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
...
<b>Note:</b>Only first 500 rows results will be displayed
        ...
        <div id="stations_select" style="display: none;"><br><span style="color: red;">This Agent have no Stations</span><br><input type="radio" id="stations_all" onchange="check_all(this);" checked="checked" style="display: none;"></div>
            <div id="players_select" style="display: none;">Player<br><input type="radio" id="players_accounts_all" onclick="check_all(this);" checked="checked">All<br><select multiple="multiple" size="4" style="width: 220px;" id="players_list" onfocus="check_list(this);"><option selected="selected" value="3927689">Test est</option></select></div>
...
//		                document.getElementById('summary_level').onchange();
  ...
  <td class="left" nowrap="nowrap" style="padding-left:15px;">
      <div class="welcome">
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'agent_game_profitability_report\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/9/2015 17:50</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
