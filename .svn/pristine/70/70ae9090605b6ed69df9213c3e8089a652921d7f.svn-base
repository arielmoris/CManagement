...
<!-- saved from url=(0045)delete_players.jsp -->
...
<div style="display:none; position:absolute; z-index:10; top:250px; left:450px;" id="loader_gif"><img src="./images/ajax-loader-transparent.gif" alt=""></div>
	<!-- window 1 -->
	<form action="delete_players.jsp" method="post" name="agent_form" id="agent_form">
	<div id="wind1" class="wins">	
		...
		<table align="center" valign="middle" width="100%" cellpadding="10" cellspacing="10" border="0">
			...
			<tr>
      			<td align="center" colspan="2" id="delete_result"><br>Are you sure you want to permanently delete  the selected&nbsp;<span id="NumberOfCustomers"></span>&nbsp;Players?<br></td>
      		</tr>
...
<table class="top" summary="" width="760" cellpadding="0" cellspacing="0" border="0">
  ...
  <tr valign="top">
	...
	<div class="system">Management System</div>
      <div class="page_title"><!--Manage agent account-->Delete Players</div>
      <br>
      <div class="tabs_table">
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td class="tabs0">&nbsp;&nbsp;</td><td class="tabs1">Delete&nbsp;Players </td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
      <div class="box_tabs">
      <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            ...
            <td>&nbsp;&nbsp;</td>
            <td>Select the players you want to delete.<img src="./images/cmt_h1_small.gif" title="Only players with zero balance can be deleted. In case you do not identify the player you want to delete in the list below, please verify that its balance is zero." style="cursor:pointer;"><br><br><i><b>Note:</b><li>Deleting a player is irreversible operation.</li><li>Maximum number of players that can be deleted is: <b>50</b></li></i></td>
          </tr>
        </tbody></table>
        <br>
	...
	<table summary="" cellpadding="0" cellspacing="0" border="0" width="70%">
          <tbody><tr>
            <td class="tab_head" align="right"><input type="button" class="button" value="  Refresh  " onclick="location.href='delete_players.php'"></td>
          </tr></tbody></table>
        <div id="list" align="center"><table summary="" cellpadding="0" cellspacing="0" border="0" width="70%">
              <tbody><tr style="display:none;">
                  <td colspan="4" id="pl_error">&nbsp;</td>
              </tr>
	         				...
	         				<td colspan="6">
	         					<form class="form-inline">
  									...
  									<div class="form-group">
    									...
    									<input type="firstName" class="show" id="firstName">
  									</div>
  									 <div class="form-group">
    									<label for=lastName class="tab_head">Last Name</label>
    									<input type="for=lastName" class="show" id="for=lastName">
  									</div>
     								<div class="form-group">
										<input type="button" class="button" style="margin-top: 23px;" value="Search" onclick="searchByAccount('');">
									</div>
								</form>
	         				</td>
	         			</tr>
	        </tbody></table><br><table id="table_list_data" class="tab_body printable table table-bordered table-condensed table-hover table-striped" summary="" cellpadding="0" cellspacing="1" border="0"><tbody><tr>
							<td class="tab_head1" align="center" nowrap="nowrap">
								<a class="tablink" onclick="sndReqSearchByAccount('0','','','','','','DeletePlayer','delete_player','ASC','STRING','','','');" style="cursor:pointer;"></a>
							</td>
							<td class="tab_head1" align="center" nowrap="nowrap">
								<a class="tablink" onclick="sndReqSearchByAccount('0','','','','','','DeletePlayer','AccountNumber','ASC','STRING','','','');" style="cursor:pointer;">Account Number</a>
							</td>
							<td class="tab_head1" align="center" nowrap="nowrap">
								<a class="tablink" onclick="sndReqSearchByAccount('0','','','','','','DeletePlayer','FirstName','ASC','STRING','','','');" style="cursor:pointer;">First Name</a>
							</td>
							<td class="tab_head1" align="center" nowrap="nowrap">
								<a class="tablink" onclick="sndReqSearchByAccount('0','','','','','','DeletePlayer','LastName','ASC','STRING','','','');" style="cursor:pointer;">Last Name</a>
							</td>
							<td class="tab_head1" align="center" nowrap="nowrap">
								<a class="tablink" onclick="sndReqSearchByAccount('0','','','','','','DeletePlayer','StatusId','ASC','STRING','','','');" style="cursor:pointer;">Status</a>
							</td></tr><tr><td class="tab_row1" align="center"><input type="checkbox" name="delete_3927689" id="delete_3927689" value="3927689" onchange="check_delete_list(this);"></td><td class="tab_row1" align="left" nowrap="nowrap">OC0001728149</td><td class="tab_row1" align="left" nowrap="nowrap">Test</td><td class="tab_row1" align="left" nowrap="nowrap">est</td><td class="tab_row1" align="center">Active</td></tr></tbody></table><script src="./scripts/ajax_functions.js" type="text/javascript"></script>
					<script type="text/javascript">
						//var session='';
						//if(!document.cookie)
						//	session='PHPSESSID=52c36376f540617efe8da2f299c833ca;
					</script>
				<div style = "padding-top:0px;"class="navigation"><input type="button" class="button" value="&#60; Back" disabled="disabled" "="" onclick="sndReqSearchByAccount('-30','','','','','','DeletePlayer','','','','','back','')">&nbsp;&nbsp;|<span style="color: white; font-size: 14px;">1</span>|&nbsp;&nbsp;<input type="button" class="button" value="Next &#62;" onclick="sndReqSearchByAccount('30','','','','','','DeletePlayer','','','','','next','')" disabled="disabled"></div>
				<div style = "padding-bottom:10px;" class="print_button"><input type="button" class="button" value="Print" onclick="window.print(); return false;"></div><div class="balance"><img src="./images/cmt_warning.gif" width="11" height="11" alt=""> <b>Total players: 1</b></div></div>
...
function searchByAccount(filter) {

        if (!filter) {
            filter = '';
        }

        var acc_field = document.getElementById('accountnumber');
        var acc_num = acc_field.value;
        //var mob_field = document.getElementById('mobilenumber');
        //var mob_num = mob_field.value;
        var mob_num = '';
        ...
        var err_field = document.getElementById('pl_error');


        if (acc_num == '' && fname == '' && lname == '') {
            ...
            fname_field.style.border = '1px solid #ff0000';
            lname_field.style.border = '1px solid #ff0000';
            return false;
        }
        else {
            err_field.parentNode.style.display = 'none';
            acc_field.style.border = '1px solid #ccc';
            fname_field.style.border = '1px solid #ccc';
            lname_field.style.border = '1px solid #ccc';
        }

        if (!(/^[0-9a-zA-Z]*$/.test(acc_num))) {
        ...
        /*if (!(/^[-+0-9()]*$/.test(mob_num))) {
            err_field.innerHTML='<div class="error"><img src="./images/cmt_error.gif" width="11" height="11" alt="" /> Error! The field contains Invalid characters. Please check and try again. Error # 1005</div>';
            err_field.parentNode.style.display = 'table-row';
            mob_field.style.border = '1px solid #ff0000';
            return false;
        }
        else {
            err_field.parentNode.style.display = 'none';
            mob_field.style.border = '1px solid #ccc';
        }*/

        if (!(/^[0-9a-zA-Z]*$/.test(fname))) {
            err_field.innerHTML='<div class="error"><img src="./images/cmt_error.gif" width="11" height="11" alt="" /> Error! The field contains Invalid characters. Please check and try again. Error # 1005</div>';
            err_field.parentNode.style.display = 'table-row';
            fname_field.style.border = '1px solid #ff0000';
            return false;
...
function GetWindowHeight()
{
	...
	//if(!document.cookie)
	//		session='PHPSESSID=52c36376f540617efe8da2f299c833ca';
	//sndReqList(0,'DeletePlayer','','','',session);
	...
	{
		var customer_list=document.getElementById('delete_list').value.substring(1,document.getElementById('delete_list').value.length-1);	
		sndReqDeleteEntity(customer_list,'','Player',session);
	}
	</script>     
        </div>
        <br><table summary="" cellpadding="0" cellspacing="0" border="0" width="70%">
          <tbody><tr>
            <td align="center"><input type="button" class="button" id="submit_button1" name="submit_button1" value="  Delete  " onclick="delete_confirmation();">&nbsp;<input type="button" class="button" id="back_button" name="back_button" value="  Cancel  " onclick="location.href='players_list.php'"></td>
          </tr></tbody></table>
      </div>
  ...
  <td class="left" nowrap="nowrap" style="padding-left:15px;">
      <div class="welcome">
					<script type="text/javascript">				
					//	setTimeout('sndReqBalance(\'Test168025\',\'delete_players\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/9/2015 12:15</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
