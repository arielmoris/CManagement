...
<!-- saved from url=(0058)https://www.totalegame.net/images.php -->
   ...
   <div class="system">Management System</div>
      ...
      <div class="tabs_table">
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            <td class="tabs0">&nbsp;&nbsp;</td><td class="tabs1">Casino&nbsp;Earnings Report&nbsp;</td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="${pageContext.request.contextPath}/agentEarningReportByAccount" class="tabsmenu">Casino&nbsp;Earnings Report&nbsp;by Player&nbsp;</a></td>
            <td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="${pageContext.request.contextPath}/agentEarningReportByStation" class="tabsmenu">Casino&nbsp;Earnings Report&nbsp;by Station&nbsp;</a></td><td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
	...
	<script type="text/javascript">
        try {
            document.getElementById("from_time_hour").disabled = true;
            document.getElementById("from_time_min").disabled = true;
            document.getElementById("to_time_hour").disabled = true;
            document.getElementById("to_time_min").disabled = true;
        } catch(e) {}
    </script>
...
if(document.getElementById("select_list"))
  ...
  <td class="left" nowrap="nowrap" style="padding-left:15px;">
      <div class="welcome">
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'images\',300)',300*1000);
					</script>
					<span id="balance">
					<div class="balance_casino">
						<b>Credit Balance 100,000.00  KRW</b>
					</div>
				</span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/9/2015 15:05</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
