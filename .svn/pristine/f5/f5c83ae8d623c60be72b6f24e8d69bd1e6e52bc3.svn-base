...
<!-- saved from url=(0053)https://www.totalegame.net/station_reset_password.php -->
    ...
    <tbody><tr valign="top">
        ...
        <table summary="" cellpadding="0" cellspacing="0" border="0">
          <tbody><tr>
            ...
            <td class="tabs1">Reset&nbsp;Password </td><td class="tabs3" onmouseover="this.className='tabs2';" onmouseout="this.className='tabs3';"><a href="${pageContext.request.contextPath}/stationResetAttempts" class="tabsmenu">Reset&nbsp;Login Attempts&nbsp;</a></td>
            <td class="tabs4">&nbsp;</td>
          </tr>
        </tbody></table>
      </div>
...
document.getElementById('error').innerHTML='';
	theform.notify_print.value=true;
	set_action();}
function set_action()
{
var session='';
...
sndReqPlayerResetPassword(document.agent_form.account_numbers.value,document.agent_form.notify_email.value,document.agent_form.notify_sms.value,document.agent_form.notify_print.value,'Station',session);
}
//-->
</script>
       <span id="error"></span>
       <form action="stations_list.jsp" method="post" name="agent_form" id="agent_form" onsubmit="return Notification_ValidateForm(this);">
       ...
       <input type="hidden" name="AccountNumber" value="">
        ...
        <table id="bulk_result"  class="printable tab_body table table-bordered table-condensed table-hover table-striped"><tbody><tr><td style="padding:3px;" class="tab_head">Account Number&nbsp;</td><td style="padding:3px;" class="tab_head">Related Product&nbsp;</td></tr><tr>
        ...
        <tr><td colspan="2">Click the Reset Password button to change the password.</td></tr>
         <tr><td colspan="2"><br></td></tr>
           <tr><td align="center" colspan="2">
           <input type="button" class="button" value="  Cancel  " onclick="location.href='${pageContext.request.contextPath}/stationsList'">&nbsp;<input type="button" name="submit_button1" id="submit_button1" class="button" value=" Reset Password  " onclick="return ValidateForm(document.getElementById('agent_form'));">
           </td></tr>
        </tbody></table>
	...
	<table summary="" cellpadding="0" cellspacing="0" border="0" id="notification_block" style="display:none;">
         ...
         <tr>
            <td></td>
            <td>&nbsp;<input type="button" class="button" name="back_button" id="back_button" value="  Cancel  " onclick="location.href='prog_stations_list.php'">&nbsp;<input type="submit" name="submit_button" id="submit_button" class="button" value="  Submit  "></td>
          </tr>
        </tbody></table>
        </form>
      </div></div>
					...
					<script type="text/javascript">				
						setTimeout('sndReqBalance(\'Test168025\',\'station_reset_password\',300)',300*1000);
					</script>
					<span id="balance"><div class="balance_casino"><b>Credit Balance 100,000.00  KRW</b></div></span>Welcome, <strong>Test1 AAagent</strong><br>Agent<br><em><font size="1px"><span id="gmt_time">1/22/2015 16:05</span><br>Time zone: GMT +9:00 (Daylight: Off) </font></em><br>
