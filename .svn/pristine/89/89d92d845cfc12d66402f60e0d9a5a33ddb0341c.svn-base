...
<body>
	...
	<div id="content">
		<div class="page_title">Add Player</div>
		<div class="tabs">
			<div class="tabs_table">
				<table summary="" cellpadding="0" cellspacing="0" border="0">
					<tbody>
						<tr>
							<td class="tabs0">&nbsp;&nbsp;</td>
							<td class="tabs1">Add&nbsp;Player</td>
							<td class="tabs3"><a href="${request_path}/addBulkPlayer" class="tabsmenu">Add&nbsp;Bulk&nbsp;Player</a></td>
							<td class="tabs4">&nbsp;</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="box_tabs" style="position: relative;">
				...
				<form:form action="${request_path}/processAddPlayer" method="post" modelAttribute="addPlayerDto" class="form-horizontal" id="addForm" autocomplete="false">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<form:input path="username" class="field required" value="" maxlength="15" id="username"/> 
						</div>
					</div>
